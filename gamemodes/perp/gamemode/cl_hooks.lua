...
--local TOPSCREEN_OVERLAY = surface.GetTextureID("materials/perp3/topscreen_overlay1");
local cState = 0;
...
--function GM:HUDPaint() 
 --   return self.DrawTopScreenOverlay(); 
--end
...
function GM.ZombieOverlay()    
    if not ClientZombieCheck then return; end
